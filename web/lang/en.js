...
window._i18n.en = {
  ...
  'overview.quota.help.p3':         '"Testing/review also stops" (default 97%, must be higher than the first): at this level QA/Cybersec/Cybered gate work stops too, every role-agent gets parked -- only the main agent stays running.',
  ...
  'localLlm.test.hint':          'Try the local model through the RAG wrapper (with the main agent memory).',
